#!/usr/bin/env python3
"""Nearfield readiness adapter for the moveit2 fork.

This fork-local adapter scores robot evaluation traces for the manipulation_planning_execution
...
PROJECT = {
    "repo": "moveit2",
    "domain": "manipulation_planning_execution",
